...
* **The Paradigm:** A Multi-Tenant SaaS. One massive database, one backend, and one web dashboard serving all gyms.
...
* **Legal Protections:** 1. Register as a **Sole Proprietorship (مؤسسة فردية)** when closing the first official paying gyms to issue tax invoices.
  2. Gym SLAs must explicitly state that the 40 JOD monthly fee covers *cloud hosting and bug fixes*, NOT building custom features for free.
...
* **Estimated Monthly Burn Rate (at 15 Gyms / 2,250 Users):** ~61 JOD/month total (Cloud SQL, Cloud Run, and Cloud Storage).
